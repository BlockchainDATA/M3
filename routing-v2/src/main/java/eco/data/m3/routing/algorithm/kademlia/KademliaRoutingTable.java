...
public class KademliaRoutingTable implements IRoutingTable {
	...
	public KademliaRoutingTable(MContentManager contentManager, MConfiguration config) {
		this.config = config;
		this.contentManager = contentManager;
		this.nodeId = contentManager.getNodeId();
	...
	public void initialize() {
		...
		try {
			List<Contact> contacts = contentManager.loadContacts();
	...
	public void save() {
		try {
			contentManager.saveContacts(getAllContacts());
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
